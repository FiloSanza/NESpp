...
namespace nespp::system_opcodes {
    ...
    void brk(Cpu &cpu) {
        ...
        cpu.get_stack().push(bits::get_high_u8(pc));
        cpu.get_stack().push(bits::get_low_u8(pc));
